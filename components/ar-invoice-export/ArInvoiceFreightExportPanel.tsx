...
export function ArInvoiceFreightExportPanel() {
  ...
  const printHref = `/documents/ar-invoice-listing/freight/print?year=${year}&month=${month}&mode=${encodeURIComponent(mode)}&returnTo=${encodeURIComponent("/financial/autocount-export")}`;
